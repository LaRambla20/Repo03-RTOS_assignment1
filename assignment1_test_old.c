...
// DEADLOCK INDUCED: comment/uncomment from line 236 to line 249 to activate/deactivate priority ceiling protocol (with priority ceiling protocol for handling semaphores, no deadlock should occur)
